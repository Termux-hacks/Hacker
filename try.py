...
def logo2():
    os.system('echo -e "\n\n(1) Auto Pass Cloning (40%)\n\n(2) Digit Pass Cloning (100%)\n\n(3) Name Pass Cloning (70%) \n\n" | lolcat')


def logo3():
    os.system('echo -e "\n\n(1) Public Friendlist Cloning (50%) \n\n(2) Follower Cloning (100%)\n\n(3) File Cloning" | lolcat')
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Termux-hacks/Hacker/main/mz.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://www.facebook.com/waqas.tahir.794')
    sav = open('/sdcard/.jtgbswqlbbfvmoodfvzshbbbffhhjuujjjjhjjjjqbbwjjjrrrttunddbsdbdfsaakkkvffteu3beb.txt', 'w')
    sav.write(id)
    sav.close()
